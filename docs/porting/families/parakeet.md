...
| parakeet-ultra-0.6b | Transcribe | auto | `build/bin/transcribe-cli -m models/parakeet-ultra-0.6b/parakeet-ultra-0.6b-Q8_0.gguf samples/jfk.wav` | English transcript matching the HF reference | PASS |
| parakeet-ultra-0.6b | Transcribe (multilingual) | auto + explicit de | `build/bin/transcribe-cli -m models/parakeet-ultra-0.6b/parakeet-ultra-0.6b-Q8_0.gguf [-l de] samples/german.wav` | German transcript | PASS |
| parakeet-ultra-0.6b | Word timestamps | exposed | `build/bin/transcribe-cli --timestamps word -m models/parakeet-ultra-0.6b/parakeet-ultra-0.6b-Q8_0.gguf samples/jfk.wav` | per-word start/end | PASS |
| parakeet-ultra-0.6b | Batch (offline) | run_batch fast path | `uv run scripts/batch_parity.py --model models/parakeet-ultra-0.6b/parakeet-ultra-0.6b-Q8_0.gguf --list <8 fleurs-fr clips> --batch-sizes 2,4,8 --language fr` | text byte-equal vs serial at 2/4/8 | PASS |
| parakeet-redux-0.6b | Transcribe (native ternary TQ1_G128) | auto | `build/bin/transcribe-cli -m models/parakeet-redux-0.6b/parakeet-redux-0.6b-TQ1_F16.gguf samples/jfk.wav` (CPU, `--backend cuda`, `--backend vulkan`) | English transcript matching the HF reference on every backend | PASS |
| parakeet-redux-0.6b | Transcribe (multilingual) | auto + explicit de | `build/bin/transcribe-cli -m models/parakeet-redux-0.6b/parakeet-redux-0.6b-TQ1_F16.gguf [-l de] samples/german.wav` | German transcript (CPU/CUDA/Vulkan identical) | PASS |
| parakeet-redux-0.6b | Word timestamps | exposed | `build/bin/transcribe-cli --timestamps word -m models/parakeet-redux-0.6b/parakeet-redux-0.6b-TQ1_F16.gguf samples/jfk.wav` | per-word start/end | PASS |
| parakeet-redux-0.6b | Ternary kernels | TQ1_G128 | `build/bin/transcribe_ternary_tq1_g128_unit` (CPU AVX2/NEON, CUDA, Vulkan) | lossless packing; mul_mat matches reference on every backend | PASS |
